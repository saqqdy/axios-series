...
axios-series 是一款企业级项目`axios`集成方案，采用 typescript 开发的 axios 扩展，集成了接口并发控制（可取消请求）功能
...
> `axios-series`自带了最新版的 axios，可以不用安装`axios`包
 ...
 * @param {object} options 请求参数AxiosSeriesRequestOptions
